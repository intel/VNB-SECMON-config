...
HTTP_RESOURCE = 'rawforwardassociation'

# RawForwardAssociation Attributes' Choices
...
def common_verify_collector_arguments(attrs):
    if attrs.get('direction') not in DIRECTIONCHOICES	:
        error_msg = _("direction has invalid choice(s) for RawForwardAssoc.")
        raise argparse.ArgumentTypeError(error_msg)


class CreateRawForwardAssociation(CommandResource):
    """Create an RawForwardAssociation"""
    resource = 'rawforwardassociation'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            ...
            help=FH(_("Collector_ID of the RawForwardAssociation")))

        parser.add_argument(
            '--originator-vm-id',
            metavar='ORIGINATOR_VM_ID',
            help=FH(_("Originator_vm_id of the RawForwardAssociation")))

        parser.add_argument(
            '--policy-id',
            metavar='POICY_ID',
            help=FH(_("Policy_id of the RawForwardAssociation")))

        parser.add_argument(
            '--scope-id',
            metavar='SCOPE_ID',
            help=FH(_("Scope_id of the RawForwardAssociation")))

        parser.add_argument(
            '--direction',
            choices=DIRECTIONCHOICES,
            help=FH(_("RawForwardAssociation Direction")))
...
class ShowRawForwardAssociation(CommandResource):
    """Show information of a given RawForwardAssociation"""
    resource = 'rawforwardassociation'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RAWFORWARDASSOCIATION',
            help=FH(_("ID of the RawForwardAssociation to search\n\n")))

        return parser


class ListRawForwardAssociation(CommandResource):
    """List RawForwardAssociation"""
    resource = 'rawforwardassociation'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
...
class UpdateRawForwardAssociation(CommandResource):
    """Update a given RawForwardAssociation"""
    resource = 'rawforwardassociation'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RAWFORWARDASSOCIATION',
            help=FH(_("ID of RawForwardAssociation to update")))
...
class DeleteRawForwardAssociation(CommandResource):
    """Delete a given RawForwardAssociation"""
    resource = 'rawforwardassociation'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RAWFORWARDASSOCIATION',
            help=FH(_("ID of RawForwardAssociation to delete")))
