...
COMMAND_COLUMNS = [
    'id',
    'name',
    'classificationobject_id',
    'priority',
    'truncate_to_size',
    'action',
]

HTTP_RESOURCE = 'ruleobject'


class CreateRuleObject(CommandResource):
    """Create an RuleObject"""
    resource = 'ruleobject'
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'name',
            metavar='NAME',
            help=FH(_("Name of the RuleObject")))

        parser.add_argument(
            '--classificationobject-id',
            metavar='CLASSIFICATIONOBJECT_ID',
            help=FH(_("ClassificationObject-ID of the RuleObject")))

        parser.add_argument(
            '--priority',
            type=check_integer_range,
            help=FH(_("Priority for RuleObject")))

        parser.add_argument(
            '--truncate-to-size',
            type=check_integer_range,
            help=FH(_("Truncate-To-Size for RuleObject")))

        parser.add_argument(
            '--action',
            help=FH(_("Action for RuleObject")))

        return parser


class ShowRuleObject(CommandResource):
    """Show information of a given RuleObject"""
    resource = 'ruleobject'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RULEOBJECT',
            help=FH(_("ID of RuleObject to search\n\n")))

        return parser


class ListRuleObject(CommandResource):
    """List RuleObject"""
    resource = 'ruleobject'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
...
class UpdateRuleObject(CommandResource):
    """Update a given RuleObject"""
    resource = 'ruleobject'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RULEOBJECT',
            help=FH(_("ID of RuleObject to update")))
...
class DeleteRuleObject(CommandResource):
    """Delete a given RuleObject"""
    resource = 'ruleobject'
    cmd_columns = COMMAND_COLUMNS
    http_resource = HTTP_RESOURCE
    ...
    def add_known_arguments(parser):
        parser.add_argument(
            'id',
            metavar='RULEOBJECT',
            help=FH(_("ID of RuleObject to delete")))
